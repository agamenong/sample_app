...
describe User do
 ...
 it "should accept valid email addresses" do
    addresses = %w[user@foo.com THEUSER@foo.bar.com first.last@foo.jp]
  ...
  it "should reject invalid email addresses" do
      addresses = %w[user@foo,com THEUSER_at_foo.com first.last@foo.]
      addresses.each do |address|
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return the user for an email/password match" do
  ...
  describe "micripost associations" do
    ...
    describe "status feed" do
      ...
      it "should not a different users microposts" do
